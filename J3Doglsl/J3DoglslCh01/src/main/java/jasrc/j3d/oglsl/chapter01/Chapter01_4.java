 ...
 * @author Arnold, J.
 */
public class Chapter01_4 extends GLSLmain {
	...
	public final static String fragment_shader_source = "#version 450\r\n" //
			...
			+ "void main()\r\n" //
			+ "{\r\n" //
			// set the color white (1.0f, 1.0f, 1.0f)
	...
	private void drawText(final float x, final float y, final int font, final String text) {
		...
		final var color = new float[] { value, // red
				value, // green
				value // blue
		};
	...
	public String getTitle() {
		return getClass().getCanonicalName() + ": white Text on black background";
	}
